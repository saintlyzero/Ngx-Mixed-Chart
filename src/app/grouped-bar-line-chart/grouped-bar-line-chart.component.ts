import {
  ...
  @Component({
    selector: 'grouped-bar-line-chart-chart-component',
    template: `
      <ngx-charts-chart
      ...
      >
        <svg:g [attr.transform]="transform" class="bar-chart chart">
          ...
          ></svg:g>
          <svg:g
            ngx-grouped-bar-line-charts-series-vertical
            [xScale]="xScale"
            [yScale]="yScale"
            [colors]="colors"
            [series]="results"
    ...
    `,
    styleUrls: ['./grouped-bar-line-chart.component.scss'],
    encapsulation: ViewEncapsulation.None
  })
  export class GroupedBarLineChartComponent extends BaseChartComponent {
